...
export default function EditEvent({eData, id}: {eData: Inputs, id: number}) {
    const start = new Date(eData.startsAt);
    const startFormatted = start.getHours() + ":" + start.getMinutes();
    const end = new Date(eData.endsAt);
    const endFormatted = end.getHours() + ":" + end.getMinutes();
    const eventDate = new Date(eData.eventDate);
    ...
    const {
        ...
        defaultValues: {
            groupId: eData.groupId.toString(),
            title: eData.title,
            address: eData.address,
            eventDate: start,
            startsAt: startFormatted,
            endsAt: endFormatted,
    ...
    const onSubmit: SubmitHandler<Inputs> = (data) => {
        ...
        axios.put(`/api/admin/events/${id}`, putData)
    ...
    console.log("data on EditEvent: ",eData);
                                ...
                                render={({ field: { onChange, onBlur, value, ref } }) => <Select onValueChange={onChange} value={value}>
                                    ...
                                    <SelectContent>
                                        <SelectGroup>
                                            ...
                                            <SelectItem value="America/Chicago">Central Daylight Time</SelectItem>
